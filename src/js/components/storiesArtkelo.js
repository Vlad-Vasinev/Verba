...
function storiesHandler(e) {
  ...
  document.querySelector('.stories-full-bigSlider').appendChild(navigationEl)
  ...
  const bigSliderObj = new Swiper('.stories-full-bigSlider', {
    ...
    on: {
      ...
      slideChange: function () {
        ...
        // if(!isMobile){
        //   const previewPrev = prevSlide.querySelector('.swiper-slide-inner:first-child img, .swiper-slide-inner:first-child video')
        //   previewPrev.src = previewPrev.dataset.src
        //   const previewNext = nextSlide.querySelector('.swiper-slide-inner:first-child img, .swiper-slide-inner:first-child video')
        //   previewNext.src = previewNext.dataset.src
        // }
      },
    },
  });

  // slide.style.setProperty('--sas', `${el.dataset.preview}`)
